...
During The Journey
- It’s boring but if you play you phone online you would probably miss your stop

After The Journey
- Sometimes causes delay because it don’t arrive on time

App Using Experience
- Hard to find the departure time and routine

**Affinity Diagrams are used to summarize the findings in the pilot study.**

**User Focus Group**
- Sample size: 4
- Research location: Nottingham
- Participants: People (who often use cars)
  
**Insights**
1. Bus views: overcrowded, slow, feels like it takes forever with all the stopping, cannot guarantee a seat, rough areas, hassle, the slowest method 
2. Car views: point-to-point, convenient, safe in rough areas, much easier to transport shopping
...
-	AI can be used to optimize the routes, schedules and vehicle allocation of DRT services based on real-time demand and environmental factors
